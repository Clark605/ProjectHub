...
namespace ProjectHub.Api.Migrations
{
    ...
    [Migration("20260920121337_AddCommentsAndTags")]
    partial class AddCommentsAndTags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.ActivityEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.ActivityEvent", b =>
                {
                    ...
                    b.HasOne("ProjectHub.Api.Models.WorkSpace", "Workspace")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.Comment", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ProjectHub.Api.Models.Task", "Task")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.Project", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.AppUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.RefreshToken", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.Task", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.AppUser", "Assignee")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectHub.Api.Models.TaskTag", b =>
                {
                    b.HasOne("ProjectHub.Api.Models.Tag", "Tag")
                        .WithMany("TaskTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
