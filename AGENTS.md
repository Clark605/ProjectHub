...
- **Database Schema**: Read [docs/database-schema.md](file:///d:/MyProgrammingProjects/DotnetProjects/ProjectHub.Api/docs/database-schema.md) for tables, columns, indexes, foreign keys, cascades, and PostgreSQL smallint enums.
